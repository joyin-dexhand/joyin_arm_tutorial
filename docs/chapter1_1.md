...
> 🖼️ **图片占位**：组装前全部零部件全家福照片

### 6.1 物料分区摆放图

组装前建议按类别分区摆放，便于核对与取用。各分区摆放图如下：
...
| B | 执行器 | 关节电机 ×6 | *待补充* |
| C | 末端执行器 | 两指夹爪 ×1 | *待补充* |
| D | 线缆模块 | USB 转 CAN 线、电机级联线 | *待补充* |
| E | 电源及配件 | 直流电源、电源线 | *待补充* |
| F | 工具与紧固件 | 螺丝、内六角扳手等 | *待补充* |
...
| 2 | 依次连接 6 个关节电机与连杆 | 拼装出六轴机械臂主体结构 | *待补充* |
| 3 | 理线并固定线缆 | 防止运动中干涉、保障通信可靠 | *待补充* |
| 4 | 安装末端执行器 | 安装夹爪，使机械臂具备作业能力 | *待补充* |
| 5 | 整体检查与手动复位 | 确认各紧固件到位、关节可顺畅转动 | *待补充* |
