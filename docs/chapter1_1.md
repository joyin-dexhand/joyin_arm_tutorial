...
> 📌 **本节定位**：面向"想立刻用起来"的读者。**无需任何理论基础**，按下面流程操作即可让 JoyArm 机械臂动起来。想深入了解原理可前往[基础篇](chapter2_1.md)。
...
> 📖 **前置准备**：电机控制软件环境搭建请先完成 [关节电机](chapter1_2.md) 章节。

### 测试流程

```mermaid
flowchart LR
    A[连接 USB-CAN] --> B[设置电机 ID]
    B --> C[上电]
    C --> D[位置控制测试]
    D --> E[速度/力矩测试]
```
...
| 怎么让机械臂真正干活？我时间有限想直接用 | 看完使用篇即可上手基础操作 | [应用篇](chapter4_1.md) |
| 怎么让机械臂动起来？我想掌握原理 | 系统学习基础篇+进阶篇的运动学与控制 | [基础篇](chapter2_1.md) |
...
| 篇章 | 内容概述 | 跳转 |
|:---|:---|:---:|
| 使用篇 | 让机械臂快速动起来的操作指南 | [关节电机](chapter1_2.md) |
| 基础篇 | 机器人学必备知识（运动学/动力学/控制） | [第1章](chapter2_1.md) |
