...
【固定骨架】
  ...
  · 正文按 ## → ### → #### 展开，每个顶级 ## 之间用 `---` 分隔。
  · 末节固定为「## 5 JoyArm 综合任务部署与联调」，对应脚本 joyarm_code/chapt/chapt4_project_demo.py。
...
【本章可引用的脚本/库】chapt4_project_demo.py、以及 joyarm/ 全部核心库。
-->
...
<!-- ✍️ 本节写作要点：
  ...
  · 主体为脚本实践，用脚本引用句式给出「对应脚本位于 `joyarm_code/chapt/chapt4_project_demo.py`，使用说明见脚本头部注释。」
