...
【全局写作规范】（详见 AGENTS.md）
  ...
  · 可复用核心库 joyarm_code/joyarm_core/：control / dynamics / joyarm / jacobian / fkine。
  ...
  · 不写"本章小结"——第 3 行概述已替代它。
【本章可引用的脚本/库】chapt9_force_demo.py（待建）、robotics/control.py、robotics/dynamics.py、joyarms/joyarm.py、robotics/jacobian.py。
-->
