...
【本章定位】基础篇·理论+实践章，承接 [第二章](chapter2_2.md) 运动学、[第三章](chapter2_3.md) 逆运动学，为 [第六章](chapter2_6.md) 运动控制提供"轨迹"输入。
...
【全局写作规范】（详见 AGENTS.md / spec/项目架构.md）
  ...
  · 图示：配图放 docs/images/chapter2_5/，未就绪用 ![图片占位：描述]()。
  · callout：> 💡 直觉/口诀  ｜  > 📌 重要说明/跨章引用  ｜  > ⚠️ 警告/注意。
  · 未知数值用 *待补充*；跨章引用用相对链接（如 [第四章](chapter2_4.md)）。
  · 不写"本章小结"——第 3 行概述已替代它。
【本章可引用的脚本/库】chapt2_trajectory_demo.py、trajectory.py、fkine.py、ikine.py。
-->
...
<!-- ✍️ 本节写作要点：
  ...
  · ⚠️ 已有"笛卡尔规划问题"提示（不可达/奇异关节速度过大/多解）保留并展开，强调与 [第四章](chapter2_4.md) §3 奇异性的关联。
  · 收尾 > 📌：笛卡尔规划的难点本质来自 IK 与奇异性（见 [第三章](chapter2_3.md)、[第四章](chapter2_4.md)）。
-->
